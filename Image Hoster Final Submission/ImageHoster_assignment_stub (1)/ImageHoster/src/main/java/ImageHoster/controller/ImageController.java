...
public class ImageController {
    ...
    @Autowired
    private CommentService commentService;                        // Users can now add comments for any image.
    ...
    public String showImage(@PathVariable("id") int id, @PathVariable("title") String title, Model model) {
        ...
        Image image = imageService.getImageByTitle(title,id);           //Fix for image upload issue.
        model.addAttribute("image", image);
        model.addAttribute("tags", image.getTags());
        model.addAttribute("comments",commentService.retrieveComments(image));   //Users can now add comments for any image.
        return "images/image";
    }
    ...
    public String editImage(@RequestParam("imageId") Integer imageId, Model model,HttpSession session) {
        ...
        // Owner of the image can now edit the image.
    ...
    public String editImageSubmit(@RequestParam("file") MultipartFile file, @RequestParam("imageId") Integer imageId, @RequestParam("tags") String tags, Image updatedImage, HttpSession session) throws IOException {
        ...
        return "redirect:/images/"+imageId+"/"+ updatedImage.getTitle();  //Fix for image upload issue.
    }
    ...
    public String deleteImageSubmit(@RequestParam(name = "imageId") Integer imageId, HttpSession session,Model model) {
        ...
        //Owner of the image can now delete the image.
